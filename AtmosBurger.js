...
var AnimSprite = function(filename,w,h,isManual) {
	if(isManual == null) isManual = false;
	this.timePerFrame = 1.0 / 60;
	this.timeElapsed = 0;
	browser.display.Sprite.call(this);
	this.set_width(w);
	this.set_height(h);
	this.source = new browser.display.Bitmap(nme.installer.Assets.getBitmapData(filename));
	this._image = new browser.display.Bitmap();
	this._image.set_width(w);
	this._image.set_height(h);
	this._image.set_bitmapData(new browser.display.BitmapData(w,h));
	this._image.set_x(-2);
	this._image.set_y(-h);
	this.anims = new Hash();
	this.manualAnim = isManual;
	this.currentFrame = 0;
	this.position = new browser.geom.Point();
	this.addChild(this._image);
	this.addEventListener(browser.events.Event.ENTER_FRAME,$bind(this,this.draw));
};
$hxClasses["AnimSprite"] = AnimSprite;
AnimSprite.__name__ = ["AnimSprite"];
AnimSprite.__super__ = browser.display.Sprite;
AnimSprite.prototype = $extend(browser.display.Sprite.prototype,{
	draw: function(event) {
		if(!this.manualAnim) {
			var cTime = this.timeElapsed;
			var cAnim = this.anims.get(this.currentAnimName);
			if(this.lastFrameChangeTime == null) {
				this.currentFrame = cAnim.frames[this.frameIndex];
				this.lastFrameChangeTime = cTime;
			} else if(cTime - this.lastFrameChangeTime > cAnim.dt) {
				this.frameIndex++;
				this.frameIndex %= cAnim.frames.length;
				this.currentFrame = cAnim.frames[this.frameIndex];
				this.lastFrameChangeTime = cTime;
			}
		}
		this._image.bitmapData.copyPixels(this.source.bitmapData,new browser.geom.Rectangle(this.currentFrame * this.get_width(),0,this.get_width(),this.get_height()),new browser.geom.Point());
	...
	,playAnim: function(name) {
		var cAnim = this.anims.get(name);
		if(cAnim == null) {
			haxe.Log.trace("animation " + name + " not defined",{ fileName : "AnimSprite.hx", lineNumber : 76, className : "AnimSprite", methodName : "playAnim"});
			return;
		}
		this.currentAnimName = name;
		this.playing = true;
		this.currentFrame = cAnim.frames[0];
		this.frameIndex = 0;
	}
	,addAnim: function(name,frames,dt) {
		var newAnim = { dt : dt, frames : frames};
		this.anims.set(name,newAnim);
	}
...
ApplicationMain.main = function() {
	...
	ApplicationMain.loaders.set("assets/bbun.png",loader);
	ApplicationMain.total++;
	var loader1 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/lettuce.png",loader1);
	ApplicationMain.total++;
	var loader2 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/meat.png",loader2);
	ApplicationMain.total++;
	var loader3 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/restaurant.png",loader3);
	ApplicationMain.total++;
	var loader4 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/sbun.png",loader4);
	ApplicationMain.total++;
	var loader5 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/small/arm.png",loader5);
	ApplicationMain.total++;
	var loader6 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/small/bbun.png",loader6);
	ApplicationMain.total++;
	var loader7 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/small/claw.png",loader7);
	ApplicationMain.total++;
	var loader8 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/small/flag.png",loader8);
	ApplicationMain.total++;
	var loader9 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/small/lettuce.png",loader9);
	ApplicationMain.total++;
	var loader10 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/small/meat.png",loader10);
	ApplicationMain.total++;
	var loader11 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/small/restaurant.png",loader11);
	ApplicationMain.total++;
	var loader12 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/small/sbun.png",loader12);
	ApplicationMain.total++;
	var loader13 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/small/tomato.png",loader13);
	ApplicationMain.total++;
	var loader14 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/stars.png",loader14);
	ApplicationMain.total++;
	var urlLoader = new browser.net.URLLoader();
	urlLoader.dataFormat = browser.net.URLLoaderDataFormat.TEXT;
	ApplicationMain.urlLoaders.set("assets/templates/audio.js",urlLoader);
	ApplicationMain.total++;
	var urlLoader1 = new browser.net.URLLoader();
	urlLoader1.dataFormat = browser.net.URLLoaderDataFormat.TEXT;
	ApplicationMain.urlLoaders.set("assets/templates/index.html",urlLoader1);
	ApplicationMain.total++;
	var urlLoader2 = new browser.net.URLLoader();
	urlLoader2.dataFormat = browser.net.URLLoaderDataFormat.TEXT;
	ApplicationMain.urlLoaders.set("assets/templates/jsfx.js",urlLoader2);
	ApplicationMain.total++;
	var urlLoader3 = new browser.net.URLLoader();
	urlLoader3.dataFormat = browser.net.URLLoaderDataFormat.BINARY;
	ApplicationMain.urlLoaders.set("assets/templates/jsfxlib.js",urlLoader3);
	ApplicationMain.total++;
	var loader15 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/title.png",loader15);
	ApplicationMain.total++;
	var loader16 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/tomato.png",loader16);
	ApplicationMain.total++;
	if(ApplicationMain.total == 0) ApplicationMain.begin(); else {
		...
		while( $it0.hasNext() ) {
			...
			loader17.load(new browser.net.URLRequest(path));
		}
		...
		while( $it1.hasNext() ) {
			...
			urlLoader4.load(new browser.net.URLRequest(path));
		}
	}
}
...
ApplicationMain.getAsset = function(inName) {
	if(inName == "assets/bbun.png") return nme.installer.Assets.getBitmapData("assets/bbun.png");
	if(inName == "assets/lettuce.png") return nme.installer.Assets.getBitmapData("assets/lettuce.png");
	if(inName == "assets/meat.png") return nme.installer.Assets.getBitmapData("assets/meat.png");
	if(inName == "assets/restaurant.png") return nme.installer.Assets.getBitmapData("assets/restaurant.png");
	if(inName == "assets/sbun.png") return nme.installer.Assets.getBitmapData("assets/sbun.png");
	if(inName == "assets/small/arm.png") return nme.installer.Assets.getBitmapData("assets/small/arm.png");
	if(inName == "assets/small/bbun.png") return nme.installer.Assets.getBitmapData("assets/small/bbun.png");
	if(inName == "assets/small/claw.png") return nme.installer.Assets.getBitmapData("assets/small/claw.png");
	if(inName == "assets/small/flag.png") return nme.installer.Assets.getBitmapData("assets/small/flag.png");
	if(inName == "assets/small/lettuce.png") return nme.installer.Assets.getBitmapData("assets/small/lettuce.png");
	if(inName == "assets/small/meat.png") return nme.installer.Assets.getBitmapData("assets/small/meat.png");
	if(inName == "assets/small/restaurant.png") return nme.installer.Assets.getBitmapData("assets/small/restaurant.png");
	if(inName == "assets/small/sbun.png") return nme.installer.Assets.getBitmapData("assets/small/sbun.png");
	if(inName == "assets/small/tomato.png") return nme.installer.Assets.getBitmapData("assets/small/tomato.png");
	if(inName == "assets/sound/applause.mp3") return nme.installer.Assets.getSound("assets/sound/applause.mp3");
	if(inName == "assets/stars.png") return nme.installer.Assets.getBitmapData("assets/stars.png");
	if(inName == "assets/templates/audio.js") return nme.installer.Assets.getText("assets/templates/audio.js");
	if(inName == "assets/templates/index.html") return nme.installer.Assets.getText("assets/templates/index.html");
	if(inName == "assets/templates/jsfx.js") return nme.installer.Assets.getText("assets/templates/jsfx.js");
	if(inName == "assets/templates/jsfxlib.js") return nme.installer.Assets.getBytes("assets/templates/jsfxlib.js");
	if(inName == "assets/title.png") return nme.installer.Assets.getBitmapData("assets/title.png");
	if(inName == "assets/tomato.png") return nme.installer.Assets.getBitmapData("assets/tomato.png");
	return null;
}
...
ApplicationMain.preloader_onComplete = function(event) {
	...
	ApplicationMain.preloader = null;
	if(Reflect.field(AtmosBurger,"main") == null) {
		var mainDisplayObj = new AtmosBurger();
		if(js.Boot.__instanceof(mainDisplayObj,browser.display.DisplayObject)) nme.Lib.get_current().addChild(mainDisplayObj);
	} else Reflect.field(AtmosBurger,"main").apply(AtmosBurger,[]);
}
var AtmosBurger = function() {
	browser.display.Sprite.call(this);
	this.initialize();
};
$hxClasses["AtmosBurger"] = AtmosBurger;
AtmosBurger.__name__ = ["AtmosBurger"];
AtmosBurger._instance = null;
AtmosBurger.Game = function() {
	return AtmosBurger._instance;
}
AtmosBurger.main = function() {
	AtmosBurger._instance = new AtmosBurger();
	nme.Lib.get_current().addChild(AtmosBurger._instance);
}
...
var Burger = function(cback,isLarge) {
	if(isLarge == null) isLarge = false;
	this.size = 19;
	browser.display.Sprite.call(this);
	if(isLarge) this.size = 50;
	this.burgerPieces = new Array();
	this.set_x(nme.Lib.get_stage().get_width() / 2 + 150);
	this.set_y(nme.Lib.get_stage().get_height() - this.size * 4.5);
	this.burgerFinishedCB = cback;
};
$hxClasses["Burger"] = Burger;
Burger.__name__ = ["Burger"];
Burger.__super__ = browser.display.Sprite;
Burger.prototype = $extend(browser.display.Sprite.prototype,{
	addBurgerPiece: function(piece) {
		piece.set_y(4 * this.size - (this.burgerPieces.length / 6 | 0) * this.size);
		piece.set_x((this.burgerPieces.length % 6 | 0) * this.size + this.size / 2);
		this.burgerPieces.push(piece);
		this.addChild(piece);
		if(this.burgerPieces.length == 24) this.burgerFinishedCB();
	}
	,getBurgerPieces: function() {
		return this.burgerPieces;
	}
	,calcRating: function() {
		var score = 0;
		var _g = 0;
		while(_g < 6) {
			var i = _g++;
			if(this.burgerPieces[i].getIngredient() == Ingredient.BBun) score += 1.25 / 6; else if(this.burgerPieces[i].getIngredient() == Ingredient.SBun) score += 0.125;
		}
		var _g = 18;
		while(_g < 24) {
			var i = _g++;
			if(this.burgerPieces[i].getIngredient() == Ingredient.SBun) score += 1.25 / 6; else if(this.burgerPieces[i].getIngredient() == Ingredient.BBun) score += 0.125;
		}
		var _g = 6;
		while(_g < 12) {
			var i = _g++;
			if(this.burgerPieces[i].getIngredient() == Ingredient.Meat) score += 1.25 / 6; else if(this.burgerPieces[i].getIngredient() == Ingredient.Lettuce || this.burgerPieces[i].getIngredient() == Ingredient.Tomato) score += 0.5 / 6;
		}
		var _g = 12;
		while(_g < 18) {
			var i = _g++;
			if(this.burgerPieces[i].getIngredient() == Ingredient.Lettuce || this.burgerPieces[i].getIngredient() == Ingredient.Tomato) score += 1.25 / 6; else if(this.burgerPieces[i].getIngredient() == Ingredient.Meat) score += 0.5 / 6;
		}
		return score;
	}
	,burgerFinishedCB: null
	,size: null
	,burgerPieces: null
	,__class__: Burger
});
var Ingredient = $hxClasses["Ingredient"] = { __ename__ : ["Ingredient"], __constructs__ : ["BBun","Meat","Lettuce","Tomato","SBun","Bird"] }
Ingredient.BBun = ["BBun",0];
Ingredient.BBun.toString = $estr;
Ingredient.BBun.__enum__ = Ingredient;
Ingredient.Meat = ["Meat",1];
Ingredient.Meat.toString = $estr;
Ingredient.Meat.__enum__ = Ingredient;
Ingredient.Lettuce = ["Lettuce",2];
Ingredient.Lettuce.toString = $estr;
Ingredient.Lettuce.__enum__ = Ingredient;
Ingredient.Tomato = ["Tomato",3];
Ingredient.Tomato.toString = $estr;
Ingredient.Tomato.__enum__ = Ingredient;
Ingredient.SBun = ["SBun",4];
Ingredient.SBun.toString = $estr;
Ingredient.SBun.__enum__ = Ingredient;
Ingredient.Bird = ["Bird",5];
Ingredient.Bird.toString = $estr;
Ingredient.Bird.__enum__ = Ingredient;
var BurgerPiece = function(i,isLarge) {
	if(isLarge == null) isLarge = false;
	this.timePerFrame = 1.0 / 60;
	this.timeElapsed = 0;
	this.isFlying = true;
	...
	var bm;
	this.ingredient = i;
	var prefix = "assets/" + (isLarge?"":"small/");
	switch( (i)[1] ) {
	case 0:
		bm = new browser.display.Bitmap(nme.installer.Assets.getBitmapData(prefix + "bbun.png"));
		break;
	case 1:
		bm = new browser.display.Bitmap(nme.installer.Assets.getBitmapData(prefix + "meat.png"));
		break;
	case 2:
		bm = new browser.display.Bitmap(nme.installer.Assets.getBitmapData(prefix + "lettuce.png"));
		break;
	case 3:
		bm = new browser.display.Bitmap(nme.installer.Assets.getBitmapData(prefix + "tomato.png"));
		break;
	case 4:
		bm = new browser.display.Bitmap(nme.installer.Assets.getBitmapData(prefix + "sbun.png"));
		break;
	case 5:
		bm = new browser.display.Bitmap(nme.installer.Assets.getBitmapData(prefix + "claw.png"));
		break;
	}
	bm.set_x(-bm.get_width() / 2);
	bm.set_y(-bm.get_height() / 2);
	this.addChild(bm);
	if(this.ingredient == Ingredient.Bird) {
		this.baseX = -150;
		this.baseY = Math.random() * (nme.Lib.get_stage().get_height() - 500) + 80;
		...
		this.baseX = Math.random() * (nme.Lib.get_stage().get_width() - this.get_width() / 2) + this.get_width() / 2;
		this.baseY = Math.random() * (nme.Lib.get_stage().get_height() - 300) + 80;
		this.set_x(this.baseX);
		this.set_y(this.baseY);
		this.phase = Math.random() * 2 + 2;
		this.phaseOffset = Math.random() * Math.PI / 2;
		this.amplitude = Math.random() * 90 + 10;
		this.velocityX = Math.random() * 250 - 125;
	}
};
$hxClasses["BurgerPiece"] = BurgerPiece;
BurgerPiece.__name__ = ["BurgerPiece"];
BurgerPiece.__super__ = browser.display.Sprite;
BurgerPiece.prototype = $extend(browser.display.Sprite.prototype,{
	bobUp: function(time) {
		if(this.isFlying) com.eclecticdesignstudio.motion.Actuate.tween(this,time,{ y : this.get_y() - 25}).ease(com.eclecticdesignstudio.motion.easing.Quad.get_easeInOut()).onComplete($bind(this,this.bobDown),[time]);
	}
	,bobDown: function(time) {
		if(this.isFlying) com.eclecticdesignstudio.motion.Actuate.tween(this,time,{ y : this.get_y() + 25}).ease(com.eclecticdesignstudio.motion.easing.Quad.get_easeInOut()).onComplete($bind(this,this.bobUp),[time]);
	}
	,update: function(event) {
		if(this.isFlying) {
			if(this.ingredient == Ingredient.Bird) {
				this.set_y(this.baseY + Math.sin(this.timeElapsed / this.phase * Math.PI * 2 + this.phaseOffset) * this.amplitude);
				if(this.get_x() < -200) {
					this.set_x(nme.Lib.get_stage().get_width() + 150);
					this.baseY = Math.random() * (nme.Lib.get_stage().get_height() - 500) + 80;
				} else if(this.get_x() > nme.Lib.get_stage().get_width() + 200) {
					this.set_x(-150);
					this.baseY = Math.random() * (nme.Lib.get_stage().get_height() - 500) + 80;
				}
				var _g = this;
				_g.set_x(_g.get_x() + this.velocityX * this.timePerFrame);
			} else {
				this.set_y(this.baseY + Math.sin(this.timeElapsed / this.phase * Math.PI * 2 + this.phaseOffset) * this.amplitude);
				if(this.get_x() - this.get_width() / 2 < 0 || this.get_x() + this.get_width() / 2 > nme.Lib.get_stage().get_width()) this.velocityX *= -1;
				var _g = this;
				_g.set_x(_g.get_x() + this.velocityX * this.timePerFrame);
			}
		}
...
var Claw = function() {
	...
	this.baseX = 0;
	browser.display.Sprite.call(this);
	this.arm = new browser.display.Bitmap(nme.installer.Assets.getBitmapData("assets/small/arm.png"));
	this.arm.set_y(-this.arm.get_height() / 2);
	this.addChild(this.arm);
	this.claw = new browser.display.Bitmap(nme.installer.Assets.getBitmapData("assets/small/claw.png"));
	this.claw.set_x(this.arm.get_width());
	this.claw.set_y(-this.claw.get_height() / 2);
	this.addChild(this.claw);
	this.baseX = nme.Lib.get_stage().get_width() / 2;
	this.baseY = nme.Lib.get_stage().get_height() - 101;
	this.set_x(this.baseX);
	this.set_y(this.baseY);
	nme.Lib.get_stage().addEventListener(browser.events.Event.ENTER_FRAME,$bind(this,this.update));
};
$hxClasses["Claw"] = Claw;
Claw.__name__ = ["Claw"];
Claw.__super__ = browser.display.Sprite;
Claw.prototype = $extend(browser.display.Sprite.prototype,{
	distance: function(x1,y1,x2,y2) {
		var x_ = x2 - x1;
		var y_ = y2 - y1;
		return Math.sqrt(x_ * x_ + y_ * y_);
	}
	,getIsRetracting: function() {
		return this.isRetracting;
	}
	,setIsRetracting: function(isRetracting) {
		this.isRetracting = isRetracting;
	}
	,getIsOut: function() {
		return this.isOut;
	}
	,setIsOut: function(isOut) {
		this.isOut = isOut;
		if(!isOut) {
			this.isRetracting = false;
	...
	,getArmEndY: function() {
		return this.localToGlobal(new browser.geom.Point(this.arm.get_x() + this.arm.get_width() + this.claw.get_width() / 2,this.arm.get_y() + this.arm.get_height() / 2)).y;
	}
	,getArmEndX: function() {
		return this.localToGlobal(new browser.geom.Point(this.arm.get_x() + this.arm.get_width() + this.claw.get_width() / 2,this.arm.get_y() + this.arm.get_height() / 2)).x;
	}
	,removeListeners: function() {
		nme.Lib.get_stage().removeEventListener(browser.events.MouseEvent.MOUSE_DOWN,$bind(this,this.onClick));
		nme.Lib.get_stage().removeEventListener(browser.events.Event.ENTER_FRAME,$bind(this,this.update));
		this.set_rotation(-90);
	}
	,update: function(event) {
		if(!this.isOut) {
			var angle = Math.atan2(nme.Lib.get_stage().get_mouseY() - this.baseY,nme.Lib.get_stage().get_mouseX() - this.baseX) / Math.PI * 180;
			if(angle > 0) {
				if(angle < 90) angle = 0; else angle = 180;
			}
	...
	,drawLine: function() {
		...
		this.get_graphics().moveTo(this.arm.get_width(),0);
		this.get_graphics().lineTo(this.claw.get_x(),0);
	}
	,retract: function(speed) {
		var distance = this.target.x - this.arm.get_width();
		var time = distance / speed;
		this.setIsRetracting(true);
		com.eclecticdesignstudio.motion.Actuate.tween(this.claw,time,{ x : this.arm.get_width()}).ease(com.eclecticdesignstudio.motion.easing.Linear.get_easeNone()).onComplete($bind(this,this.setIsOut),[false]).onUpdate($bind(this,this.drawLine));
		return time;
	}
	,onClick: function(event) {
		if(this.isOut) return;
		this.target = this.globalToLocal(new browser.geom.Point(event.stageX,event.stageY));
		var distance = this.target.x - this.arm.get_width();
		var time = distance / 750.0;
		this.setIsOut(true);
		com.eclecticdesignstudio.motion.Actuate.tween(this.claw,time,{ x : this.target.x}).ease(com.eclecticdesignstudio.motion.easing.Linear.get_easeNone()).onComplete($bind(this,this.retract),[750.0]).onUpdate($bind(this,this.drawLine));
	}
	,target: null
	,arm: null
	,claw: null
...
PlayScene.__super__ = browser.display.Sprite;
PlayScene.prototype = $extend(browser.display.Sprite.prototype,{
	getResultsScene: function(b,intoAbyss) {
		var _g = this;
		var blackBox = new browser.display.Shape();
		blackBox.get_graphics().beginFill(0);
		blackBox.get_graphics().drawRect(0,0,nme.Lib.get_stage().get_width(),nme.Lib.get_stage().get_height());
		blackBox.alpha = 0;
		this.addChild(blackBox);
		com.eclecticdesignstudio.motion.Actuate.tween(blackBox,0.6,{ alpha : 1}).onComplete(function() {
			AtmosBurger.Game().changeScene(new ResultsScene(_g.burger,0.0));
		});
	}
	,checkStabbedBurger: function() {
		if(this.sceneEnding) return;
		this.burger.set_x(nme.Lib.get_stage().get_mouseX() - this.burger.get_width() / 2);
		if(this.flag.get_y() > this.burger.get_y() + 57 && this.flag.get_x() >= this.burger.get_x() && this.flag.get_x() <= this.burger.get_x() + this.burger.get_width()) {
			this.sceneEnding = true;
			com.eclecticdesignstudio.motion.Actuate.stop(this.flag);
			this.getResultsScene(this.burger,false);
		}
	}
	,dropFlag: function() {
		this.sounds.playFall();
		com.eclecticdesignstudio.motion.Actuate.tween(this.flag,4.0,{ y : nme.Lib.get_stage().get_height()}).ease(com.eclecticdesignstudio.motion.easing.Quad.get_easeIn()).onUpdate($bind(this,this.checkStabbedBurger)).onComplete($bind(this,this.getResultsScene),[this.burger,true]);
		this.claw.removeListeners();
	}
	,update: function(event) {
		var _g = 0, _g1 = this.burgerPieces;
		while(_g < _g1.length) {
			var p = _g1[_g];
			++_g;
			p.update(event);
		}
		if(this.claw.getIsOut() && !this.claw.getIsRetracting()) {
			var hiti = -1;
			var _g1 = 0, _g = this.burgerPieces.length;
			while(_g1 < _g) {
				var i = _g1++;
				if(this.claw.hitTestObject(this.burgerPieces[i])) {
					hiti = i;
					this.sounds.playGrab();
					this.burgerPieces[i].setIsFlying(false);
					com.eclecticdesignstudio.motion.Actuate.stop(this.claw);
					var time = this.claw.retract(750);
					com.eclecticdesignstudio.motion.Actuate.tween(this.burgerPieces[i],time,{ x : this.claw.getArmEndX(), y : this.claw.getArmEndY()}).ease(com.eclecticdesignstudio.motion.easing.Linear.get_easeNone()).onComplete(($_=this.burger,$bind($_,$_.addBurgerPiece)),[this.burgerPieces[i]]);
					break;
				}
			}
			if(hiti != -1) this.burgerPieces.splice(hiti,1);
		}
	}
	,initialize: function() {
		var _g = this;
		this.sceneEnding = false;
		var skymatrix = new browser.geom.Matrix();
		skymatrix.createGradientBox(nme.Lib.get_stage().get_width(),nme.Lib.get_stage().get_height(),Math.PI / 2);
		var skysquare = new browser.display.Shape();
		skysquare.get_graphics().beginGradientFill(browser.display.GradientType.LINEAR,[6989285,5896423],[1,1],[0,255],skymatrix);
		skysquare.get_graphics().drawRect(0,0,nme.Lib.get_stage().get_width(),nme.Lib.get_stage().get_height());
		this.addChild(skysquare);
		var restaurant = new browser.display.Bitmap(nme.installer.Assets.getBitmapData("assets/small/restaurant.png"));
		restaurant.set_x(nme.Lib.get_stage().get_width() / 2 - restaurant.get_width() / 2);
		restaurant.set_y(nme.Lib.get_stage().get_height() - restaurant.get_height());
		this.addChild(restaurant);
		this.claw = new Claw();
		this.addChild(this.claw);
		this.sounds = new Sounds();
		nme.Lib.get_stage().addEventListener(browser.events.MouseEvent.MOUSE_DOWN,function(e) {
			_g.claw.onClick(e);
			_g.sounds.playFire();
		});
		this.flag = new AnimSprite("assets/small/flag.png",36,108);
		this.flag.addAnim("wave",[0,1],0.1);
		this.flag.playAnim("wave");
		this.flag.set_x(Math.random() * nme.Lib.get_stage().get_width() * 2 / 4 + nme.Lib.get_stage().get_width() / 4);
		...
		while(_g1 < 24) {
			var i = _g1++;
			if(i < 6) piece = new BurgerPiece(Ingredient.BBun); else if(i < 12) piece = new BurgerPiece(Ingredient.Meat); else if(i < 15) piece = new BurgerPiece(Ingredient.Tomato); else if(i < 18) piece = new BurgerPiece(Ingredient.Lettuce); else piece = new BurgerPiece(Ingredient.SBun);
			this.burgerPieces.push(piece);
			this.addChild(piece);
		}
		this.burger = new Burger($bind(this,this.dropFlag));
		this.addChild(this.burger);
		this.addEventListener(browser.events.Event.ENTER_FRAME,$bind(this,this.update));
	}
	,sounds: null
	,sceneEnding: null
	,flag: null
...
var ResultsScene = function(b,flagOffset) {
	browser.display.Sprite.call(this);
	var blackBox = new browser.display.Shape();
	blackBox.get_graphics().beginFill(0);
	blackBox.get_graphics().drawRect(0,0,nme.Lib.get_stage().get_width(),nme.Lib.get_stage().get_height());
	this.addChild(blackBox);
	this.burger = new Burger(function() {
	},true);
	this.burger.set_x(50);
	this.burger.set_y(150);
	var input = b.getBurgerPieces();
	var _g = 0;
	while(_g < input.length) {
		var p = input[_g];
		++_g;
		this.burger.addBurgerPiece(new BurgerPiece(p.getIngredient(),true));
	}
	var t = new browser.text.TextField();
	var tf = new browser.text.TextFormat();
	tf.size = 40;
	tf.color = 16777215;
	t.setTextFormat(tf);
	t.set_text("Your burger scores...");
	t.set_x(300);
	t.set_y(120);
	var score = this.burger.calcRating();
	this.addChild(this.burger);
	this.addChild(t);
	var stars = new browser.display.Bitmap(nme.installer.Assets.getBitmapData("assets/stars.png"));
	stars.set_x(410);
	stars.set_y(245);
	stars.alpha = 0;
	this.addChild(stars);
	var starWidth = stars.get_width() / 5;
	var covering = new browser.display.Shape();
	covering.get_graphics().beginFill(0);
	covering.get_graphics().drawRect(0,0,stars.get_width(),stars.get_height());
	covering.set_x(stars.get_x() + stars.get_width() - starWidth * (5 - score));
	covering.set_y(245);
	this.addChild(covering);
...
ResultsScene.__super__ = browser.display.Sprite;
ResultsScene.prototype = $extend(browser.display.Sprite.prototype,{
	getMolyQuote: function() {
		var molyquotes = ["I still have nightmares about holding German sausages over my head.","You and your girlfriend will enjoy this like you've never enjoyed\n" + "anything else in your life.","If you love your dog, we're gonna mess with your mind, man. You're\n" + "not going to be able to go to bed.","Will the first female nudity give you a success or will it turn off\n" + " the audience?","When you watch a film, you think why does the baddy have to lose? In\n" + "James Bond, I always thought it's so unfair, it must have taken ages\n" + "to build that base and think of the staffing costs!","The more times you die, the more you get scarred, the more ugly and\n" + "disfigured you will look, and the more the world will react.","The engine isn't finished. Her buttocks are wrong.","If you go into battle, you could win a ginger-haired person!","It's easy for me to guess that people like relaxation, but was there\n" + "a way I could measure it?","I'm not punishing you for button mashing; I'm rewarding you for not\n" + "button mashing, and that is a really big distinction.","You can actually break someone's neck on some railing during combat.\n" + "It could be a spike on a fence or a solid brick wall, and you'll get\n" + "increased experience for that as well.","It's you Americans. There's something about nipples you hate. If this\n" + "were Germany, we'd be romping around naked on the stage here.","Some people leave artwork, some people do rude things, other people\n" + "then turn those rude things into nice things.","This time I'm going to make it really tough to be good. Truly being\n" + "good is all about sacrifice. How much are you going to sacrifice to\n" + "do good?","Part of the fun of dogs is they misbehave and can be enormously\n" + "embarrassing to the owner.","Remember, this is a role playing game; all the different weapons\n" + "have different music sounds and give a very individual feel to the\n" + "combat.","..it is enormously contentious for us to do a game, a story, an \n" + "experience, about a boy. You are immediately appealing to all the\n" + "dark thoughts of humanity.","There is an acorn, and it is a golden acorn. We're taking acorns\n" + " to the next level.","Pull the right trigger to see The Most Interesting Thing in the World.","What do you want, as a player, to be when you play football, and\n" + "what do you want to feel when you play?","I used to have this chat-up line, my only chat-up line. Imagine\n" + "you're walking on a path - what's the path like? Imagine you go\n" + "to the woods - what does the forest look like?","What do the taps mean?","Allow players to marry each other; allow them to have children\n together.","You sneak that little thing in there at the end.","And if I really was a hero, and were in a world that was, you know,\n" + "a world of heroes... I don't think I would be like Robin Hood. I \n" + "think I want to keep a bit of the money. I'd give SOME away, but\n" + "I wouldn't give it ALL away. I just think that's crazy.","I'm only going to make one more game, I think. And that thought – \n" + "the thought of every ounce of my energy, every ounce of my experience,\n" + "every mistake that I've made in every single game – if I can learn\n" + "from that, and use that energy to make one game… that's what I'm\n" + "trying to do. ","I'm angry. I'm super angry. My wife is barely talking to me now,\n" + "because she lost a million gold coins.","I have to be careful what I say, there are PR policeman in the\n" + "audience with sniper rifles.","When you're doing it in multiplayer, it feels incredible. I love that.","They could start combining magic together and switching between guns\n" + "and swords, because they were the same.","The most powerful story I could possibly tell is a story that\n" + "reminds you of your own childhood. We've all had times in our\n" + "childhood, common experiences when we felt down, and we felt up,\n" + "or we celebrated doing something for the first time, and I loved that\n" + "thought.","Americans are all celebrating how much they hate the British at\n" + "the moment.","When you rip your fingers on the screen and you tear the landscape\n" + "apart with your physical hands, it just feels amazing, man. \n" + "It feels amazing.","You can shake people's hands, you can hug them, too. We were\n" + "inspired by the American man hug - although please don't do it\n" + "with British people, we find the closeness of the genitalia\n" + "really frightening.","I keep finding myself rejected by men, which is a new experience\n" + "for me.","I think the worst time for me that I've ever had an inspirational\n" + "idea, which was an idea for a feature in Black & White, was actually\n" + "when I was being intimate with my wife.","We've got tons of graphs and data coming in, and looking at that is\n" + "the most inspirational thing I have seen as a game designer, ever.","We're explorers who have just discovered this new continent of emotion.","I actually have an almost physical love for Microsoft.","I could be alone in a pub drinking a pint of bitter. Come along!","The British people hate successful people; that's why our newspapers\n" + "are so successful -- because we as a nation build people up, and as\n" + "soon as they smell success we smash them down into the ground again! ","The whole of your body, except for your private parts, can be scarred.\n" + "You are clothed most of the time, but not in front of your wife,\n" + "and not when you swim, either. Don't forget, it's the emotion of\n" + "being scarred.","Freedom is... freedom can actually be boring, you've got to realize\n" + "that.","If you really were free to do anything in the world, I think you'd\n" + "end up being confused, and that's a very interesting point, a design\n" + "point, actually.","I want you to think of the sword as a conductor's baton. As you're\n" + "fighting, we'll be introducing different musical elements, the more\n" + "successful you are. And we'll be upping the tempo of the music, the\n" + "more abilities that you unlock. So you not only get more of a score,\n" + "you get a cooler soundtrack.","I thought, if this crashes the plane, me turning my phone on, so be it","There's this new thing called the digital relationship: we have a\n" + "digital relationship with players now.","The trouble with a lot of Hollywood stuff is—I'm so bored with it.\n" + "James Bond, Tom Cruise—the character of the hero is locked in concrete.\n" + "He must have a love interest, they must end up in bed, he never talks\n" + "under torture. The only surprise is whether they're on top of a cliff\n" + "or under water.","To go back to those grass roots again, and to go and get your hands so\n" + "incredibly dirty from fiddling around.","You can eliminate starvation or you can double it, you can empty the\n" + "treasury or fill it with gold and rub it all over your body?","If you could imagine, there was this hill completely full of people,\n" + "like a forest of people. It was quite scary, actually.","You're a rebel and being this rebel, you need to get people to follow\n" + "you, and they'll do it if you promise to do certain things – you have\n" + "to sign a piece of paper.","I'm 52 years old. I have a strange attitude to life. I consider it a\n" + "marathon that you've got to keep pushing yourself through. I just hope\n" + "I'm coming near the end of it.","His purpose in life - like Asimov's laws of robotics - is not to\n" + "aggravate you; Not to piss you off. His second thought is this: He\n" + "absolutely loves you.","They seem so old-school, but three years ago we had them all over\n" + "the place.","You know what this industry's like, as soon as there is the scent\n" + "of death, everyone jumps on the hearse.","Simon and Dene, I worry about them. I lose sleep thinking,\n" + "are they all right?","I don't think experiments should be just experiments.\n" + "They should start becoming things.","I want you to experience things like unconditional love –\n" + "that's what I'm trying to get to.","The fact I have to filter those friends by their skill and by what\n" + "they're able to do... There's an incredible opportunity there.","I wish I had some time machine and could go back two weeks.\n" + "You live by your mistakes, for sure.","The touch, the grab, the stroke, all of those things\n" + "we're going to be obsessed about."];
		return molyquotes[Math.random() * molyquotes.length | 0];
	}
	,fadeInQuote: function(s) {
		var t = new browser.text.TextField();
		var tf = new browser.text.TextFormat();
		tf.size = 20;
		tf.color = 16777215;
		...
		t.alpha = 0;
		this.addChild(t);
		com.eclecticdesignstudio.motion.Actuate.tween(t,3.0,{ alpha : 1});
	}
	,burger: null
	,__class__: ResultsScene
});
var Std = function() { }
$hxClasses["Std"] = Std;
Std.__name__ = ["Std"];
...
var TitleScene = function() {
	...
	this.get_graphics().drawRect(0,0,nme.Lib.get_stage().get_width(),nme.Lib.get_stage().get_height());
	var bm = new browser.display.Bitmap(nme.installer.Assets.getBitmapData("assets/title.png"));
	bm.set_x(nme.Lib.get_stage().get_width() / 2 - bm.get_width() / 2);
	bm.set_y(nme.Lib.get_stage().get_height() / 2 - bm.get_height() / 2);
	this.addChild(bm);
	nme.Lib.get_stage().addEventListener(browser.events.MouseEvent.CLICK,$bind(this,this.startGame));
};
$hxClasses["TitleScene"] = TitleScene;
TitleScene.__name__ = ["TitleScene"];
TitleScene.__super__ = browser.display.Sprite;
TitleScene.prototype = $extend(browser.display.Sprite.prototype,{
	startGame: function(d) {
		nme.Lib.get_stage().removeEventListener(browser.events.MouseEvent.CLICK,$bind(this,this.startGame));
...
$hxClasses["com.eclecticdesignstudio.motion.easing.Linear"] = com.eclecticdesignstudio.motion.easing.Linear;
com.eclecticdesignstudio.motion.easing.Linear.__name__ = ["com","eclecticdesignstudio","motion","easing","Linear"];
com.eclecticdesignstudio.motion.easing.Linear.__properties__ = {get_easeNone:"get_easeNone"}
com.eclecticdesignstudio.motion.easing.Linear.easeNone = null;
com.eclecticdesignstudio.motion.easing.Linear.get_easeNone = function() {
	return new com.eclecticdesignstudio.motion.easing.LinearEaseNone();
}
com.eclecticdesignstudio.motion.easing.LinearEaseNone = function() {
};
$hxClasses["com.eclecticdesignstudio.motion.easing.LinearEaseNone"] = com.eclecticdesignstudio.motion.easing.LinearEaseNone;
...
com.eclecticdesignstudio.motion.easing.LinearEaseNone.prototype = {
	ease: function(t,b,c,d) {
		return c * t / d + b;
	}
	,calculate: function(k) {
	...
	,__class__: com.eclecticdesignstudio.motion.easing.LinearEaseNone
}
com.eclecticdesignstudio.motion.easing.Quad = function() { }
$hxClasses["com.eclecticdesignstudio.motion.easing.Quad"] = com.eclecticdesignstudio.motion.easing.Quad;
com.eclecticdesignstudio.motion.easing.Quad.__name__ = ["com","eclecticdesignstudio","motion","easing","Quad"];
com.eclecticdesignstudio.motion.easing.Quad.__properties__ = {get_easeOut:"get_easeOut",get_easeInOut:"get_easeInOut",get_easeIn:"get_easeIn"}
...
com.eclecticdesignstudio.motion.easing.Quad.get_easeIn = function() {
	return new com.eclecticdesignstudio.motion.easing.QuadEaseIn();
}
com.eclecticdesignstudio.motion.easing.Quad.get_easeInOut = function() {
	return new com.eclecticdesignstudio.motion.easing.QuadEaseInOut();
}
com.eclecticdesignstudio.motion.easing.Quad.get_easeOut = function() {
	return new com.eclecticdesignstudio.motion.easing.QuadEaseOut();
}
com.eclecticdesignstudio.motion.easing.QuadEaseIn = function() {
};
$hxClasses["com.eclecticdesignstudio.motion.easing.QuadEaseIn"] = com.eclecticdesignstudio.motion.easing.QuadEaseIn;
...
com.eclecticdesignstudio.motion.easing.QuadEaseIn.prototype = {
	ease: function(t,b,c,d) {
		return c * (t /= d) * t + b;
	}
	,calculate: function(k) {
	...
	,__class__: com.eclecticdesignstudio.motion.easing.QuadEaseIn
}
com.eclecticdesignstudio.motion.easing.QuadEaseInOut = function() {
};
$hxClasses["com.eclecticdesignstudio.motion.easing.QuadEaseInOut"] = com.eclecticdesignstudio.motion.easing.QuadEaseInOut;
...
com.eclecticdesignstudio.motion.easing.QuadEaseInOut.prototype = {
	ease: function(t,b,c,d) {
	...
	,__class__: com.eclecticdesignstudio.motion.easing.QuadEaseInOut
}
com.eclecticdesignstudio.motion.easing.QuadEaseOut = function() {
};
$hxClasses["com.eclecticdesignstudio.motion.easing.QuadEaseOut"] = com.eclecticdesignstudio.motion.easing.QuadEaseOut;
...
com.eclecticdesignstudio.motion.easing.QuadEaseOut.prototype = {
	ease: function(t,b,c,d) {
		return -c * (t /= d) * (t - 2) + b;
	}
	,calculate: function(k) {
	...
	,__class__: com.eclecticdesignstudio.motion.easing.QuadEaseOut
}
var format = {}
format.display = {}
...
nme.installer.Assets.initialize = function() {
	if(!nme.installer.Assets.initialized) {
		nme.installer.Assets.resourceNames.set("assets/bbun.png","assets/bbun.png");
		nme.installer.Assets.resourceTypes.set("assets/bbun.png","image");
		nme.installer.Assets.resourceNames.set("assets/lettuce.png","assets/lettuce.png");
		nme.installer.Assets.resourceTypes.set("assets/lettuce.png","image");
		nme.installer.Assets.resourceNames.set("assets/meat.png","assets/meat.png");
		nme.installer.Assets.resourceTypes.set("assets/meat.png","image");
		nme.installer.Assets.resourceNames.set("assets/restaurant.png","assets/restaurant.png");
		nme.installer.Assets.resourceTypes.set("assets/restaurant.png","image");
		nme.installer.Assets.resourceNames.set("assets/sbun.png","assets/sbun.png");
		nme.installer.Assets.resourceTypes.set("assets/sbun.png","image");
		nme.installer.Assets.resourceNames.set("assets/small/arm.png","assets/small/arm.png");
		nme.installer.Assets.resourceTypes.set("assets/small/arm.png","image");
		nme.installer.Assets.resourceNames.set("assets/small/bbun.png","assets/small/bbun.png");
		nme.installer.Assets.resourceTypes.set("assets/small/bbun.png","image");
		nme.installer.Assets.resourceNames.set("assets/small/claw.png","assets/small/claw.png");
		nme.installer.Assets.resourceTypes.set("assets/small/claw.png","image");
		nme.installer.Assets.resourceNames.set("assets/small/flag.png","assets/small/flag.png");
		nme.installer.Assets.resourceTypes.set("assets/small/flag.png","image");
		nme.installer.Assets.resourceNames.set("assets/small/lettuce.png","assets/small/lettuce.png");
		nme.installer.Assets.resourceTypes.set("assets/small/lettuce.png","image");
		nme.installer.Assets.resourceNames.set("assets/small/meat.png","assets/small/meat.png");
		nme.installer.Assets.resourceTypes.set("assets/small/meat.png","image");
		nme.installer.Assets.resourceNames.set("assets/small/restaurant.png","assets/small/restaurant.png");
		nme.installer.Assets.resourceTypes.set("assets/small/restaurant.png","image");
		nme.installer.Assets.resourceNames.set("assets/small/sbun.png","assets/small/sbun.png");
		nme.installer.Assets.resourceTypes.set("assets/small/sbun.png","image");
		nme.installer.Assets.resourceNames.set("assets/small/tomato.png","assets/small/tomato.png");
		nme.installer.Assets.resourceTypes.set("assets/small/tomato.png","image");
		nme.installer.Assets.resourceNames.set("assets/sound/applause.mp3","assets/sound/applause.mp3");
		nme.installer.Assets.resourceTypes.set("assets/sound/applause.mp3","music");
		nme.installer.Assets.resourceNames.set("assets/stars.png","assets/stars.png");
		nme.installer.Assets.resourceTypes.set("assets/stars.png","image");
		nme.installer.Assets.resourceNames.set("assets/templates/audio.js","assets/templates/audio.js");
		nme.installer.Assets.resourceTypes.set("assets/templates/audio.js","text");
		nme.installer.Assets.resourceNames.set("assets/templates/index.html","assets/templates/index.html");
		nme.installer.Assets.resourceTypes.set("assets/templates/index.html","text");
		nme.installer.Assets.resourceNames.set("assets/templates/jsfx.js","assets/templates/jsfx.js");
		nme.installer.Assets.resourceTypes.set("assets/templates/jsfx.js","text");
		nme.installer.Assets.resourceNames.set("assets/templates/jsfxlib.js","assets/templates/jsfxlib.js");
		nme.installer.Assets.resourceTypes.set("assets/templates/jsfxlib.js","binary");
		nme.installer.Assets.resourceNames.set("assets/title.png","assets/title.png");
		nme.installer.Assets.resourceTypes.set("assets/title.png","image");
		nme.installer.Assets.resourceNames.set("assets/tomato.png","assets/tomato.png");
		nme.installer.Assets.resourceTypes.set("assets/tomato.png","image");
...
nme.installer.Assets.getBitmapData = function(id,useCache) {
	...
	if(nme.installer.Assets.resourceNames.exists(id) && nme.installer.Assets.resourceTypes.exists(id) && nme.installer.Assets.resourceTypes.get(id).toLowerCase() == "image") {
		...
		} else haxe.Log.trace("[nme.Assets] There is no asset library named \"" + libraryName + "\"",{ fileName : "Assets.hx", lineNumber : 213, className : "nme.installer.Assets", methodName : "getBitmapData"});
	} else haxe.Log.trace("[nme.Assets] There is no BitmapData asset with an ID of \"" + id + "\"",{ fileName : "Assets.hx", lineNumber : 219, className : "nme.installer.Assets", methodName : "getBitmapData"});
	return null;
}
nme.installer.Assets.getBytes = function(id) {
	...
	haxe.Log.trace("[nme.Assets] There is no String or ByteArray asset with an ID of \"" + id + "\"",{ fileName : "Assets.hx", lineNumber : 238, className : "nme.installer.Assets", methodName : "getBytes"});
	return null;
}
nme.installer.Assets.getFont = function(id) {
	...
	haxe.Log.trace("[nme.Assets] There is no Font asset with an ID of \"" + id + "\"",{ fileName : "Assets.hx", lineNumber : 259, className : "nme.installer.Assets", methodName : "getFont"});
	return null;
}
nme.installer.Assets.getMovieClip = function(id) {
	...
	var symbolName = HxOverrides.substr(id,id.indexOf(":") + 1,null);
	if(nme.installer.Assets.libraryTypes.exists(libraryName)) {
	} else haxe.Log.trace("[nme.Assets] There is no asset library named \"" + libraryName + "\"",{ fileName : "Assets.hx", lineNumber : 311, className : "nme.installer.Assets", methodName : "getMovieClip"});
	return null;
}
...
nme.installer.Assets.getSound = function(id) {
	...
	haxe.Log.trace("[nme.Assets] There is no Sound asset with an ID of \"" + id + "\"",{ fileName : "Assets.hx", lineNumber : 347, className : "nme.installer.Assets", methodName : "getSound"});
	return null;
}
